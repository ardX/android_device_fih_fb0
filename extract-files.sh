...
PRODUCT_COPY_FILES += \\
    vendor/__VENDOR__/__DEVICE__/proprietary/libv8.so:system/lib/libv8.so \\
    vendor/__VENDOR__/__DEVICE__/proprietary/libmm-color-convertor.so:system/lib/libmm-color-convertor.so \\
    vendor/__VENDOR__/__DEVICE__/proprietary/libmmosal.so:system/lib/libmmosal.so \\
    vendor/__VENDOR__/__DEVICE__/proprietary/libmmparser.so:system/lib/libmmparser.so \\
    vendor/__VENDOR__/__DEVICE__/proprietary/libmmparser_divxdrmlib.so:system/lib/libmmparser_divxdrmlib.so
EOF
